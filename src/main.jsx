...
function FlowtapeLandingV2() {
  ...
  const miniTracks = [["Drums", "#d8ff6a", 12, 34], ["Voice", "#ee9dff", 30, 22], ["Textures", "#7db8ff", 6, 47]];
  return <main className="landing-v3">
    <header className="landing-v3-nav"><a href="?landing" className="landing-v3-brand"><span>f</span>flowtape</a><a href="#download" className="landing-v3-download"><span></span> macOS <i/> <span>⊞</span> Windows</a></header>
    <section className="landing-v3-hero"><div className="landing-v3-kicker"><i/> TURN A FEELING INTO A MIX</div><h1>Make your ideas<br/><em>move.</em></h1><p>Build a mixtape, shape a transition, and make every sound feel exactly where it belongs.</p><div className="landing-v3-actions"><a href="#features">Explore the studio <ChevronRight size={15}/></a></div><div className="landing-v3-proof"><span>Apple silicon & Intel</span><i/> <span>Windows ready</span><i/> <span>Local-first</span></div></section>
    <section className="landing-v3-stage-wrap" aria-label="Flowtape studio preview"><div className="landing-v3-stage-shadow"/><div className="landing-v3-stage" style={{ transform: `scale(${0.86 + landingScroll * 0.14}) translateY(${(1 - landingScroll) * 42}px)` }}><div className="landing-v3-windowbar"><div><i/><i/><i/></div><b><span>f</span> flowtape</b><small>Late Summer</small></div><div className="landing-v3-workspace"><aside><small>MIXTAPE</small><b>Late Summer</b><span>A quiet ride towards morning.</span><div className="landing-v3-project"><i/><div><b>Late Summer</b><small>Mixtape</small></div><ChevronDown size={13}/></div><div className="landing-v3-links"><em>Studio</em><span>Library <i>01</i></span><span>Sounds <i>869</i></span></div></aside><main><header><div><small>MIXTAPE</small><b>Late Summer</b></div><div className="landing-v3-transport"><button><Play size={13} fill="currentColor"/></button><span>0:33 <i>/ 6:00</i></span><em>92 BPM</em></div></header><div className="landing-v3-ruler"><span>TRACKS <b>03</b></span><i>0:00</i><i>1:30</i><i>3:00</i><i>4:30</i></div>{miniTracks.map(([name,color,left,width]) => <div className="landing-v3-track" key={name}><div><i style={{background:color}}/><b>{name}</b><small>● ● ●</small></div><section><article style={{left:`${left}%`,width:`${width}%`,background:`${color}95`}}><b>{name === "Drums" ? "daylight break" : name === "Voice" ? "soft spoken" : "vinyl room"}</b><div>{Array.from({length:22},(_,index)=><i key={index} style={{height:`${20 + ((index * 19) % 58)}%`}}/>)}</div></article></section></div>)}<div className="landing-v3-sounds"><small>YOUR SOUND COLLECTION</small><div><button><Play size={12}/></button><b>Sample Song <span>3:36</span></b><em>Drag a sound to a track</em></div></div></main></div></div></section>
    <section className="landing-v3-features" id="features"><div><span>01</span><h2>Made to stay simple.</h2><p>Drag, trim, split, fade, and arrange clips on a clear multi-track timeline.</p><Layers size={18}/></div><div><span>02</span><h2>A library that stays ready.</h2><p>Browse included samples, import MP3 or WAV files, search, favourite, preview, and drag them right into your mix.</p><Music2 size={18}/></div><div><span>03</span><h2>Shape every transition.</h2><p>Record voice, add effects, use tempo and metronome tools, then export only the audio you use.</p><SlidersHorizontal size={18}/></div></section>
    <section className="landing-v3-download-section" id="download"><div><div className="landing-v3-kicker"><i/> FLOWTAPE DESKTOP</div><h2>Ready when the<br/><em>idea arrives.</em></h2></div><div className="landing-v3-download-options"><a href="#download" className="landing-v3-download"><span></span> Download for macOS</a><a href="#download" className="landing-v3-windows"><span>⊞</span> Download for Windows</a></div></section>
    <footer className="landing-v3-footer"><a href="?landing" className="landing-v3-brand"><span>f</span>flowtape</a><span>Made for mixes with feeling.</span><nav><a href="#imprint">Imprint</a><a href="#privacy">Privacy</a><a href="#terms">Terms</a></nav></footer>
  </main>;
}
